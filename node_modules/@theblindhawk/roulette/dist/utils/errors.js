const errors = {
    invalidContainer: (container) => 'Invalid container "' + container + '". Please provide a valid container',
    invalidSection: (index) => 'Error tryi ' + index + '. Please provide a valid section',
    index_out_of_bounds: (index) => 'Index ' + index + ' is out of bounds. Please provide a valid index',
